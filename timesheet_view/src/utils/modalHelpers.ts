...
export const createEventFromDuplicateData = (duplicateData: any): Event => {
    ...
    return {
        ...
        billabletype: duplicateData.billableType,
        paymenttobe: duplicateData.paymentToBe,
        paymentto: duplicateData.paymentTo,
        concessiontype: duplicateData.concessionType,
